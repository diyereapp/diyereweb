...
useEffect(() => {
 ...
 const [brands, setBrands] = useState([]);
  ...
  <Header />
    ...
    <main><div class="bg-slate-100"><div class="text-slate-900 bg-inherit"><div class="mx-auto max-w-[1440px] px-6"><nav class="pt-4" aria-label="Breadcrumb"><ol class="flex items-center"><li class="flex items-center"><a class="whitespace-nowrap text-rush-blue-500
     hover:text-rush-blue-600 hover:underline" href="../catalog/index.html">All Products</a>
 ...
 <section className="py-8">
  ...
  <ul className="flex flex-col">
    {parents.map((parent) => (
      ...
      <main class="col-span-full flex flex-col gap-8 md:col-span-3"><section class="flex flex-col overflow-hidden rounded-2xl bg-gradient-to-r from-[#0679CB] to-[#2AA5FF]/90 text-white md:flex-row"><div class="flex flex-col gap-4 px-4 py-6 md:max-w-1/2 md:justify-center md:px-12"><h1 class="text-4xl font-extrabold md:text-5xl">{name}</h1><p class="text-lg font-semibold text-slate-200">Design customized {name} in minutes. Pick your style, upload your logo, and we&#x27;ll handle the rest.</p><ul class="flex flex-col gap-2 text-lg"><li><a class="inline-flex items-center whitespace-nowrap ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary-foreground h-12 rounded-2xl px-8 text-lg w-full justify-center border-rush-blue-900 bg-rush-blue-900 py-3 font-bold transition-opacity duration-200 hover:bg-rush-blue-900 hover:opacity-75" href="all/index.html">Shop All {name}</a>
