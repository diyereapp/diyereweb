              ...
              >
                ...
                >
                  {[
                    ...
                    "What endpoints can I use to manage users?",
                    "How do I fetch transaction history?",
                    "Can I get usage limits for each role?",
                  ].map((question, index) => (
                    <button
                      key={index}
                      onClick={() =>
                        setMessages((prev) => [
                          ...
                          {
                            sender: "ai",
                            text: "Thanks for your question! Here's the info...",
